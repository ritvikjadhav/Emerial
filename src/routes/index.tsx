...
function Index() {
  ...
  return (
    <>
      ...
      {/* 8. NEW OPTIMIZED LUXURY BRAND FOOTER */}
      <footer className="relative bg-black pt-20 pb-12 overflow-hidden select-none">
        {/* Razor Thin Emerald Accent Divider Line */}
        <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-primary-glow/55 to-transparent" />

        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          {/* Main Structural Accordion Matrix */}
          <div className="grid grid-cols-1 md:grid-cols-5 gap-y-3 md:gap-x-8 lg:gap-x-12 pb-16">
            
            {/* Minimalist Signature Branding Unit */}
            <div className="md:col-span-1 flex flex-col items-start mb-10 md:mb-0">
          ...
          {/* Lower Base Ground — Airy yet Compact Footer Layer */}
          <div className="pt-8 border-t border-border/10 flex flex-col md:flex-row items-center justify-between gap-6">
            <p className="text-[10px] text-muted-foreground/50 tracking-wider font-sans text-center md:text-left">
              &copy; 2026 Maison Emerial SA. Swiss Made. All rights reserved.
            </p>
            
            {/* Single Clean Row of Active Social Media Links */}
            <div className="flex flex-row items-center gap-6">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Emerial Instagram" className="p-2 text-muted-foreground hover:text-primary-glow transition-colors duration-300">
                <Instagram className="h-4 w-4" />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="Emerial YouTube" className="p-2 text-muted-foreground hover:text-primary-glow transition-colors duration-300">
                <Youtube className="h-4 w-4" />
              </a>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Emerial Facebook" className="p-2 text-muted-foreground hover:text-primary-glow transition-colors duration-300">
