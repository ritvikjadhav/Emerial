...
function Index() {
  ...
  return (
    <>
      {/* HERO SECTION */}
      <section className="relative min-h-[100svh] flex items-center overflow-hidden pt-24 bg-background">
        {/* Glowing Ambient Background Elements & Particles */}
        ...
        <div className="relative z-20 mx-auto max-w-[1440px] px-6 lg:px-10 w-full grid lg:grid-cols-[1.1fr_1fr] gap-16 items-center">
          <div className="animate-rise">
            ...
            <div className="mt-10 flex flex-wrap gap-4 items-center">
              ...
              <Link to="/craftsmanship" className="btn-ghost-luxury">
                Discover More
              </Link>
            </div>
          </div>
          
          {/* THE FLOATING WATCH HOUSING */}
        ...
        {/* THE GLOWING SCROLL INDICATOR ARROW */}
      ...
      {/* STATS GRID */}
      <section className="relative border-y border-border/60 py-20 bg-onyx">
      ...
      <section className="relative py-32 bg-onyx">
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              { t: "Swiss Precision", d: "COSC-grade regulation." },
              { t: "Premium Materials", d: "Sapphire, gold, carbon." },
              { t: "Luxury Packaging", d: "Hand-lacquered oak vitrine." },
              { t: "Worldwide Shipping", d: "Complimentary, insured." },
              { t: "5-Year Warranty", d: "International concierge." },
            ].map((w, i) => (
